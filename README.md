...
```javascript
import sub from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-ops-sub@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-strided-ops-sub/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/math-strided-ops-sub/actions/workflows/test.yml?query=branch:v0.2.2
